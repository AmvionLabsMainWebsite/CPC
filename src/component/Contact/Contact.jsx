      ...
      {load ? (
        ...
        <div className="container-fluid text-black">
          <div>
            ...
            <header className="absolute md:top-36 lg:top-36 xl:top-36 md:ml-20 lg:ml-20 xl:ml-20 laptop:text-white tablet:text-maincol mt-4">
              <h1 className=" md:text-3xl lg:text-3xl xl:text-3xl text-2xl md:ml-0 ml-14 text-left font-bold text-white">
                Want to know more? <br /> We are here to HELP!!!
              </h1>
            ...
            <div className="grid grid-cols-12 gap-4 ">
              <div className="md:col-span-6 lg:col-span-6 xl:col-span-6 col-span-12 p-4 shadow-md">
                ...
                <form onSubmit={handleSubmit} className="mt-10 max-w-lg mx-auto">
                  ...
                  <div className="mb-4">
                    <label className="text-maincol font-bold mb-2">Name</label>
                    <input
                      type="text"
                      value={name}
                      placeholder="Your Name"
                      onChange={(e) => setName(e.target.value)}
                      className="border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none placeholder:text-gray-500 placeholder:opacity-70"
                      required
                    />
                  </div>

                  <div className="mb-4">
                    <label className="text-maincol font-bold mb-2">Email</label>
                    <input
                      type="email"
                      value={email}
                      ...
                      className={`border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none ${emailError ? "border-red-500" : ""
                        }`}
                      required
                    />
                    {emailError && (
                  ...
                  <div className="mb-4">
                    <label className="text-maincol font-bold mb-2">Phone Number</label>
                    ...
                    <input
                      ...
                      className={`border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none ${phoneError ? "border-red-500" : "border-gray-300"
                        }`}
                      required
                    />
                  ...
                  <div className="mb-4">
                    <label className="text-maincol font-bold mb-2">Message</label>
                    <textarea
                      id="message"
                      name="message"
                      value={message}
                  ...
                  <div className="mb-4">
                    <input
                      type="submit"
                      value="Submit"
                      className={`bg-maincol text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer
                  ...
                  showPopup && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                      <div className="bg-white p-10 pt-10 pb-10 rounded shadow-lg text-center ">
                        <h2 className="text-xl font-bold mt-2">your enquiry is submitted we will get back to you soon</h2>
