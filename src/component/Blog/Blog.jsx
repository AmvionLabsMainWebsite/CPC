      ...
      {load ? (
        ...
        <div className="scroll-smooth">
          <div className="grid grid-cols-1 ">
            ...
            <header className="md:absolute md:top-36 md:ml-20 md:text-white sm:text-black">
              <h1 className="md:text-3xl lg:text-3xl xl:text-3xl text-4xl md:text-left lg:text-left xl:text-left  mt-4 font-bold text-white">
                Everlife CPC Diagnostics Blog
              </h1>
