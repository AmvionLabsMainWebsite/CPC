...
import blog6 from "../../assets/image/blog-7.jpg";
...
const blogs = [
  ...
  //this is second blog
  {
    ...
    date: "May 25, 2024",
    image: blog2,
    h1map: "Difference Between 3-Part and 5-Part Hematology Analyzer",
  ...
  //this is third blog
  {
    ...
    date: "Feb 27, 2024",
    image: blog3,
    h1map: "Biochemistry Analyzer: Working Principle and Uses",
  ...
  //this is fourth blog
  {
    ...
    date: " Jul 6, 2023",
    image: blog4,
    h1map: "What Is Hemoglobin? Types of Blood Disorders Explained",
  ...
  //this is fifth blog
  {
    ...
    date: "Jul 6, 2023",
    image: blog5,
    h1map: "An Introduction to a Fully Automated Immunoassay Analyzer",
  ...
  //this is sixth blog
  {
    ...
    date: "Jul 6, 2023",
    image: blog6,
    h1map: "How to Ensure Accurate Results in Hematology Analyzers",
  ...
  //this is seventh blog
  {
    ...
    date: "Feb 13, 2023",
    image: blog7,
    h1map: "Basics of a 3-Part Hematology Analyzer",
  ...
  //this is eighth blog
  {
    ...
    date: "Feb 2, 2023",
    image: blog8,
    h1map: "Understanding Microalbuminuria",
  ...
  //this is ninth blog
  {
    ...
    date: "Dec 8, 2022",
    image: blog9,
    h1map: "Allergies: Causes, Symptoms and Diagnosis",
  ...
  //this is tenth blog
  {
    ...
    date: "Dec 6, 2022",
    image: blog10,
    h1map: "Novel Treatment Modalities for Lethal Diseases",
  ...
  //this is eleventh blog
  {
    ...
    date: "Nov 29, 2022",
    image: blog11,
    h1map: "Understanding Lab Mean in Diagnostics",
  ...
  //this is twelvth blog
  {
    ...
    date: "Oct 12, 2022",
    image: blog12,
    h1map: "Introduction to Rheumatoid Factor",
  ...
  //this is thirteenth blog
  {
    ...
    date: " Sep 12, 2022",
    image: blog13,
    h1map: "Lipid Profile Test: Importance and Components",
  ...
  //this is Fourteenth blog
  {
    ...
    date: "Aug 31, 2022",
    image: blog14,
    h1map: "Heart Attack and Cardiac Biomarkers",
  ...
  //this is Fifteenth blog
  {
    ...
    date: "Aug 6, 2022",
    image: blog15,
    h1map: "Blood Disorders Explained",
  ...
  //this is Sixteenth blog
  {
    ...
    date: "Jun 20, 2022",
    image: blog16,
    h1map: "Hyperlipidemia in Atherosclerosis",
  ...
  //this is seventeenth blog
  {
    ...
    date: "May 9, 2022",
    image: blog17,
    h1map: "All About Anti-Phospholipid Syndrome",
  ...
  //this is Eighteenth blog
  {
    ...
    date: "May 9, 2022",
    image: blog18,
    h1map: "Understanding Systemic Sclerosis",
...
function SingleBlog() {
  ...
  const blogSchema = blogSchemas[slug];
  ...
  return (
    <div className="container-fluid">
            ...
            __html: JSON.stringify(
              {
                ...
                "headline": blogSchema.headline || blog.title,
                "description": blogSchema.description,
                "image": blogSchema.image,
                "author": {
                  "@type": "Organization",
                  "name": "Everlife CPC Diagnostics",
                ...
                "publisher": {
                  ...
                  "logo": {
                    "@type": "ImageObject",
                    "url": "https://cpcdiagnostics.in/assets/logo-DM8X79DO.png"
                  }
                },
      ...
      <div className=" mt-10 p-10 text-center">
        <div>
          <h1 className="text-4xl text-maincol font-semibold">{blog.h1map}</h1>
        </div>
