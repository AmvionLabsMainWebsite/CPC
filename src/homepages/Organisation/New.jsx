    ...
    <>
      ...
      <div className="laptop:hidden tablet:mb-[100px]">
        ...
        <div className="flex flex-col items-center justify-center p-2 gap-4 mb-2">
          <img src={image2} alt="Group photo of Everlife CPC Diagnostics and Sachika members" />

          <div className="flex flex-col items-center justify-center">
            <p className="mb-2 text-center text-[13px] text-maincol font-semibold">
              Empowering Doctors in Autoimmune Diagnostics for Over 14 Years
            </p>
            <div className="">
              {" "}
              {/* <VscDebugBreakpointData className="text-green-900 " /> */}
              <p className="text-[11px] tablet:text-[1rem] mt-2 ml-2 text-justify flex items-center">
                Sachika is a pioneering initiative by CPC Diagnostics Pvt. Ltd., established over 14 years ago with a singular vision — to advance diagnostic excellence in India through continuous medical education. Sachika is a first-of-its-kind knowledge and training centre for autoimmune disease diagnostics in the country that empowers doctors and laboratorians to make informed decisions, thereby improving patient outcomes.
              </p>
            </div>
          </div>
